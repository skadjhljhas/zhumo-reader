...
若你用 AI 生成带注释的学术文本，可直接采用仓库内置的
[`docs/ai-writing-prompt.md`](docs/ai-writing-prompt.md) 中的「渲染环境说明」提示词：
把它粘进 AI 的系统提示词，AI 产出的 Markdown 即可在朱墨中正确呈现注释与公式。
该说明只描述渲染行为，不限制写作风格。
