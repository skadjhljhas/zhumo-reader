...
渲染层依赖会编译进应用资源；2.0 新增组件的完整许可证随包保存在 `docs/licenses/`。
...
| [@mdit/plugin-tex](https://mdit-plugins.github.io/) | MIT |
| [CodeMirror 6](https://codemirror.net/) 与 Lezer | MIT |
| [MathJax](https://www.mathjax.org/) | Apache-2.0 |
| [Mermaid](https://mermaid.js.org/) 11.17.2 | MIT；其运行依赖与许可证原文见 [清单](docs/licenses/mermaid/README.md) |
...
| [yauzl](https://github.com/thejoshwolfe/yauzl) 与 pend | MIT；EPUB容器读取，原文见 docs/licenses/yauzl-LICENSE 与 pend-LICENSE |
| [@xmldom/xmldom](https://github.com/xmldom/xmldom) | MIT；EPUB XML读取，原文见 docs/licenses/xmldom-LICENSE |
| [DOMPurify](https://github.com/cure53/DOMPurify) | Apache-2.0 或 MPL-2.0；内容净化，许可证随附 docs/licenses/dompurify-LICENSE |
...
| @types/node | MIT |
| @types/yauzl | MIT |
| @webgpu/types | BSD-3-Clause；类型声明，原文见 docs/licenses/webgpu-types-LICENSE |
