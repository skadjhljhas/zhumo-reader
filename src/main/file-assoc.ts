...
export const ASSOC_PROG_ID = 'ZhuMo2.Assoc'

/** 参与关联的扩展名（只写 OpenWithProgids「打开方式」，不抢默认；.txt 因 Windows
 *  UserChoice 保护仍由用户既定默认程序打开，朱墨仅出现在「打开方式」列表） */
export const ASSOC_EXTENSIONS = ['.md', '.markdown', '.epub', '.txt'] as const
...
export const ASSOC_DISPLAY_NAME = '朱墨 2.0'
