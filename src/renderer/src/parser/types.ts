...
/** Optional character provenance for one rewritten line (UTF-16 input offsets).
 * A generated reference maps to its complete source spelling. Unknown positions
 * are -1, never a guessed neighbouring offset. Newlines are structural.
 */
...
/** Optional provenance for source editing; offsets refer to the input before rewriting. */
...
export interface RenderedBook {
  selectionRanges: Map<string, import('../../../shared/note-range').NoteRange>
  selectionMetadataChars: number
  title: string
  sourceBlocks?: import('../../../shared/types').SourceBlock[]
